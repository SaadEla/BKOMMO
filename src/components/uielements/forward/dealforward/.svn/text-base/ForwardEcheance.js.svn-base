...
import {optionsContrePartie} from "../ForwardUtil";
import DatePicker from "../../DatePick";

import NumberFormat from "react-number-format";
import {DateUtil} from "../../../../helpers/Utils";
import {useDispatch} from "react-redux";
import {addDealForward, updateDealForward} from "../../../../redux/dealCapture/forward/DealForwardSlice";
import * as moment from "moment";

export function ForwardEcheance({add, update, echeance, flagUpdate = true, hideModal}) {
    ...
    function add(values) {
        dispatch(addDealForward(values))

    }
    function update(values) {
        dispatch(updateDealForward(values))
    }
