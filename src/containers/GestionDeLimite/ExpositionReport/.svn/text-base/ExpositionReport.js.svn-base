...
import RadioBox from '../../../components/uielements/radio';

import DatePicker from '../../../components/uielements/DatePick2';
...
import { loadExpositionReportListAPI, expositionReportListSelector } from '../../../redux/GestionDeLimite/expositionReportSlice';
...
function ExpositionReport  () {
  ...
  */
  ...
  useEffect(() => {
  //  dispatch(loadExpositionReportListAPI())
  });
  const refresh = () => {
    ...
    <LayoutContentWrapper style={{ height: '82vh' }}>
        <PageHeader>
          <Row>
            ...
            <Col span ={4}>
            <RadioBox color='#2181da'> Calculer la position </RadioBox>
            </Col>
            ...
            <Col span ={3}>
             <Button icon="csv" style={{borderRadius:'10px', color:'#2181da'}} primary={true} look="bare" >Exporter</Button>
            </Col>  
            <Col span = {6}>
                <Search style ={{ width : '70%', marginLeft: '33%'}}  placeholder="Quick search text" onSearch={value => console.log(value)} enterButton />
                <Breadcrumb style={{marginTop:'3%', marginLeft:'12%'}}>
                  <Breadcrumb.Item href="">
                    <HomeOutlined />
                   </Breadcrumb.Item>
                   <Breadcrumb.Item href="/app/GestionDeLimite/ExpositionReport">
                    <UserOutlined />
                    <span>Gestion De Limite</span>
                   </Breadcrumb.Item>
                   <Breadcrumb.Item>Exposition Report</Breadcrumb.Item>
                 </Breadcrumb>
            </Col>
...
export default ExpositionReport;
